#Created on Wed Dec  5 00:28:55 2018
#
#@author: Rub3z
#
#A simple(r) VGGNet.
# Version 1.1: has a bare ImageDataGenerator for use on
...
myVGGNet.add(Conv2D(64, kernel_size=(3, 3), activation='relu'))
myVGGNet.add(ZeroPadding2D((1,1)))
myVGGNet.add(Conv2D(64, kernel_size=(3, 3), activation='relu'))
myVGGNet.add(MaxPooling2D(pool_size=(2, 2), strides=(2,2)))

myVGGNet.add(ZeroPadding2D((1,1)))
myVGGNet.add(Conv2D(128, kernel_size=(3, 3), activation='relu'))
myVGGNet.add(ZeroPadding2D((1,1)))
myVGGNet.add(Conv2D(128, kernel_size=(3, 3), activation='relu'))
myVGGNet.add(MaxPooling2D(pool_size=(2, 2), strides=(2,2)))

myVGGNet.add(ZeroPadding2D((1,1)))
myVGGNet.add(Conv2D(256, kernel_size=(3, 3), activation='relu'))
myVGGNet.add(ZeroPadding2D((1,1)))
myVGGNet.add(Conv2D(256, kernel_size=(3, 3), activation='relu'))
myVGGNet.add(ZeroPadding2D((1,1)))
myVGGNet.add(Conv2D(256, kernel_size=(3, 3), activation='relu'))
...
myVGGNet.add(ZeroPadding2D((1,1)))
myVGGNet.add(Conv2D(512, kernel_size=(3, 3), activation='relu'))
myVGGNet.add(ZeroPadding2D((1,1)))
myVGGNet.add(Conv2D(512, kernel_size=(3, 3), activation='relu'))
myVGGNet.add(ZeroPadding2D((1,1)))
myVGGNet.add(Conv2D(512, kernel_size=(3, 3), activation='relu'))
...
myVGGNet.add(Dense(4096, activation= 'relu'))
