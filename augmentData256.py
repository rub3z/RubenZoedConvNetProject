# -*- coding: utf-8 -*-
"""
Created on Mon Dec 10 23:05:10 2018
...
trainDrawings = dataGenerator.flow_from_directory(
        ...
        shuffle=False,
        save_to_dir='dataset_augmented/training_set256/drawings',
        save_prefix='aug',
...
trainEngraving = dataGenerator.flow_from_directory(
        ...
        batch_size=batch_size,
        shuffle=False,
        save_to_dir='dataset_augmented/training_set256/engraving',
        save_prefix='aug',
        interpolation='lanczos'
        )
...
trainIconography = dataGenerator.flow_from_directory(
        ...
        batch_size=batch_size,
        shuffle=False,
        save_to_dir='dataset_augmented/training_set256/iconography',
        save_prefix='aug',
        interpolation='lanczos'
        )
...
trainPainting = dataGenerator.flow_from_directory(
        ...
        batch_size=batch_size,
        shuffle=False,
        save_to_dir='dataset_augmented/training_set256/painting',
        save_prefix='aug',
        interpolation='lanczos'
        )
...
trainSculpture = dataGenerator.flow_from_directory(
        ...
        batch_size=batch_size,
        shuffle=False,
        save_to_dir='dataset_augmented/training_set256/sculpture',
        save_prefix='aug',
        interpolation='lanczos'
        )
